...
class Module extends ModuleBase {
	 ...
	 *
	 * This method attaches a global JS object (`window.DT_CR_DATA`).
	 ...
	 * - Attaching inline data here ensures our global JS data (window.DT_CR_DATA) is available
	...
	protected function enqueue_block_editor_inline_data() {
		...
		$data = apply_filters( 'dt_cr_script_data', $data );

		wp_add_inline_script(
			'wp-block-editor',
			'window.DT_CR_DATA = ' . wp_json_encode( $data ) . ';'
		);
	}
