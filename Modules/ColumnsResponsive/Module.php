...
class Module extends ModuleBase implements ManagableModuleInterface {
	...
	function add_styles_to_columns( $attributes, $class_id ) {
		...
		$reverse_order = isset( $breakpoint_data[ self::ATTRIBUTE_REVERSE_ORDER ] )
			? $breakpoint_data[ self::ATTRIBUTE_REVERSE_ORDER ]
			: false;
	...
	public static function get_title() {
		return __( 'Responsive Columns', 'bbe' );
	}

	public static function get_label() {
		return __( 'Add responsiveness settings to Columns block.', 'bbe' );
	}
}
