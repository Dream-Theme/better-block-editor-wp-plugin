<?php
/**
 * Adds responsive settings to the Grid block.
 *
...
class Module extends ModuleBase implements ManagableModuleInterface {
	...
	const ASSETS_BUILD_PATH = 'editor/blocks/grid/stack-on-responsive/';
	...
	function render( $block_content, $block ) {
		...
		$css_rules = array( 'grid-template-columns' => 'repeat(1, 1fr)' );
	...
	public static function get_title() {
		return __( 'Responsive Grid', 'bbe' );
	}

	public static function get_label() {
		return __( 'Add responsiveness settings to Grid block.', 'bbe' );
	}
}
