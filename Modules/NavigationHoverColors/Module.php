...
class Module extends ModuleBase implements ManagableModuleInterface {
	...
	const ATTRIBUTE_MENU_COLOR    = 'dtCrMenuHoverColor';
	const ATTRIBUTE_SUBMENU_COLOR = 'dtCrSubmenuHoverColor';
	...
	public static function get_title() {
		return __( 'Navigation Hover Color', 'bbe' );
	}

	public static function get_label() {
		return __( 'Add Hover Color settings to Navigation block.', 'bbe' );
	}
}
