...
class Module extends ModuleBase implements ManagableModuleInterface {
	...
	const ATTRIBUTES                        = 'dtCrOverlayMenu';
	...
	public function render( $block_content, $block ) {
		...
		$block_content = BlockUtils::append_classes( $block_content, array( $class_id, 'dt-cr-responsive-navigation' ) );
	...
	public static function get_title() {
		return __( 'Responsive Navigation', 'bbe' );
	}

	public static function get_label() {
		return __( 'Add responsiveness settings to Navigation block.', 'bbe' );
	}
}
