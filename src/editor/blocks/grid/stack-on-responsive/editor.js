				...
				{ isSelected && isBlockFullyEditable( clientId ) && (
					<InspectorControls>
						<PanelBody
							...
							className="dt-cr grid__responsive-stack-on"
						>
...
addFilter(
	...
	'dt-cr/grid/responsiveness/modify-block-data',
	modifyBlockData
);

addFilter( 'editor.BlockEdit', 'dt-cr/grid/responsiveness/edit-block', extendBlockEdit );

addFilter( 'editor.BlockListBlock', 'dt-cr/grid/responsiveness/render-in-editor', renderInEditor );
