...
abstract class ModuleBase implements ModuleInterface {
	...
	/**
	 * Whether the module can be turned on/off by user.
	 *
	 * @var bool
	 */
	const MANAGABLE_BY_USER = true;
	...
	public static function is_managable_by_user() {
		return static::MANAGABLE_BY_USER;
	}
	...
	protected function get_asset_url( $key ) {
		return DT_CR_URL_DIST . $this::ASSETS_BUILD_PATH . $key;
	}
