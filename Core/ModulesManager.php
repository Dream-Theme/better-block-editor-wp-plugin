...
final class ModulesManager {
	...
	private function prepare_module_classnames() {
		...
		$module_classnames = apply_filters( 'dt_cr_modules_classnames', $module_classnames );
	...
	public function __construct() {
		...
		add_action( 'bbe/init', array( $this, 'init' ) );
	}
	...
	public function get_managable_modules_data() {
		...
		foreach ( $this->manageable_module_classnames as $classname ) {
			$data[] = array(
				...
				'is_managable_by_user' => $classname::is_managable_by_user(),
	...
	private static function is_module_enabled( $module_classname ) {
		...
		return apply_filters( 'dt_cr_is_module_enabled', $is_enabled, $module_classname );
	}
